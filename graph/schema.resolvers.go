...
import (
	...
	"github.com/makespositivechange/mongo-graphql-api/database"
...
func (r *mutationResolver) DeleteJobListing(ctx context.Context, id string) (*model.DeletedJobResponse, error) {
